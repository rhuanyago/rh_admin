...
jQuery(function($, undefined) {
	...
	var $w = $(window),
		...
		_nmObj = {
			...
			modal: true,	// Indicates if it's a modal window or not
			...
			closeButton: '<a href="item_pedido.asp" title="close"  class="nyroModalClose nyroModalCloseButton nmReposition">Close</a>',	// Close button HTML			
